    ...
    password: {
        validations: [
            ...
            },
            {
                ...
                message: "Please use at least one uppercase, lowercase letter, special character, and number.",
                condition: (input) =>
                    input.pattern &&
...
const PrimaryTemplate = ({onValidate, validators}) => {
    ...
    return html`<form @validate="${onValidate}"><in-textinput name="username" required></in-textinput></form>`;
};
...
const DisabledTemplate = ({}) => {
    return html`<in-textinput value="disabled input" disabled name="test-input"></in-textinput>`;
};
